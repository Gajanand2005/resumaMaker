  ...
  return (
    <div className='space-y-4'>
      ...
      <div className='bg-blue-50 p-3 rounded-lg '>
        <p className='text-sm text-blue-800'><strong>Tip:</strong>Add 8-12 relevant skills . Include both technical skills (programming languages, tools, frameworks) and soft skills (communication, leadership, problem-solving).</p>
      </div>
    </div>
  )
}
